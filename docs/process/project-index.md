...
- docs/process/native-coding-agent-phase-3-context-engineering-main-path.md
- docs/process/native-coding-agent-closure-audit.md
- docs/process/goal-mode-coding-agent-execution-summary.md
- docs/process/goal-mode-coding-agent-execution.md
- docs/process/goal-mode-coding-agent-execution-closure-audit.md
- docs/process/goal-mode-native-agent-coverage-expansion-summary.md
