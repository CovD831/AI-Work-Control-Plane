...
调研日期：2026-05-26  
本地位置：`/Users/abab/Desktop/AI-Work-Control-Plane/research_repos/`
...
| codewale 候选 2 | `jeelptl2005/codewale` | `research_repos/codewale-jeelptl2005` | Flask 编程学习网站，包含登录、课程、测试、证书、资料上传等；和 AI-Work-Control-Plane 的方向基本不相关。 |
