...
def test_team_setup_reports_readiness_and_recommendations(capsys, tmp_path, monkeypatch) -> None:
    ...
    (tmp_path / "pyproject.toml").write_text('version = "1.0.0rc2"\n', encoding="utf-8")
    ...
    try:
        ...
        assert out["release_readiness"]["version_sync"]["package_version"] == "1.0.0rc2"
...
def test_team_setup_json_mode_remains_machine_readable(capsys, tmp_path, monkeypatch) -> None:
    ...
    try:
        ...
        assert payload["release_readiness"]["version_sync"]["package_version"] == "1.0.0rc2"
